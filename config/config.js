...
const settings = {
  ...
  ENABLE_DAILY_USDC_TO_R2USD: process.env.ENABLE_DAILY_USDC_TO_R2USD ? process.env.ENABLE_DAILY_USDC_TO_R2USD.toLowerCase() === "true" : false,
  ENABLE_DAILY_R2USD_TO_USDC: process.env.ENABLE_DAILY_R2USD_TO_USDC ? process.env.ENABLE_DAILY_R2USD_TO_USDC.toLowerCase() === "true" : false,
  ENABLE_DAILY_STAKE_R2USD: process.env.ENABLE_DAILY_STAKE_R2USD ? process.env.ENABLE_DAILY_STAKE_R2USD.toLowerCase() === "true" : false,
  ...
  NUMBER_OF_TRANSFER: process.env.NUMBER_OF_TRANSFER && _isArray(process.env.NUMBER_OF_TRANSFER) ? JSON.parse(process.env.NUMBER_OF_TRANSFER) : [1, 10],
};
